...
- First online launch: open the app online, confirm the PWA/service worker installs, then cold reload in Airplane Mode.
...
- App close/reopen: close the PWA/browser, reopen offline, and confirm the queued visit is still listed as waiting to upload.
