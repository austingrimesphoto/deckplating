...
`v0.5.0-beta - Mission Board and pilot readiness`
...
- Updated the setup-site SQL block so new beta teams get the current schema support through Mission Board settings.
